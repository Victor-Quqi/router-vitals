...
export const SERVER_IP_DAILY_REPORT_SOFT_LIMIT = 1000;
export const SERVER_IP_DAILY_REPORT_HARD_LIMIT = 2000;
export const SERVER_IP_MINUTE_REPORT_LIMIT = 120;
...
export function isPluginVersionNewer(latestPluginVersion, currentPluginVersion = PLUGIN_VERSION) {
