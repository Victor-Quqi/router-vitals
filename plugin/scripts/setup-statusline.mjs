...
function formatStatusLineCommand(value) {
...
function hasUnrelatedStatusLine(value) {
    if (!isRecord(value))
        return false;
...
function createLauncherSource(fallbackInstallPath) {
